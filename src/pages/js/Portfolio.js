...
const Portfolio = () => {
    ...
    useEffect(() => {
        ...
        Axios.post("http://http://54.177.109.165/3009/portfolio", {
    ...
    const deleteArt = (id, art) => {
        Axios.delete(`http://http://54.177.109.165/3009/portfolio/deleteArt/${id}/${art}`)
        .then((res) => {
                    ...
                    return (
                        <div className="portfolio-artworks" key={index}>
                            <Link to={`/viewArt/${artwork.id}`}>
                                <img src={`http://http://54.177.109.165/3009/images/${artwork.art}`} alt={artwork.title} />
                            </Link>
